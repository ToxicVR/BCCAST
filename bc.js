...
client.on("message", message => {
            ...
            if (message.content.startsWith(prefix + "broad")) {
                         if (!message.member.hasPermission("MANAGE SERVER"))  return message.channel.send("u dont have premission");
...
client.login("NzU4MzM5MzU2MjQ2MTQ3MTAz.X2tgjw.Z84j_rvJPKLETZH2drWvXiq6dcw");